...
import com.ak.store.warehouseSagaWorker.model.dto.InventoryCreationRequest;
...
public class InventoryCreationInboxEventProcessor implements InboxEventProcessor {
    ...
    public void process(InboxEvent event) {
        var request = gson.fromJson(event.getPayload(), InventoryCreationRequest.class);
        inventoryService.createOne(request.getPayload().getProduct().getId());
    }
