...
@Service
public class InventoryCreationOutboxEventProcessor implements OutboxEventProcessor {
    ...
    public void process(InboxEvent event) {
        ...
        try {
            outboxEventService.createOne(event.getId(), response, OutboxEventType.INVENTORY_CREATION);
