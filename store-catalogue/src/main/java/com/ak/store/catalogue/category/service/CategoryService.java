package com.ak.store.catalogue.category.service;
...
import com.ak.store.catalogue.category.service.query.CategoryQueryService;
import com.ak.store.catalogue.category.validator.CategoryValidator;
...
public class CategoryService {
    ...
    private Category findOneById(Long id) {
        return categoryQueryService.findByIdOrThrow(id);
    }
