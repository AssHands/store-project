package com.ak.store.catalogue.product.service;
...
import com.ak.store.catalogue.product.service.query.ProductCharacteristicQueryService;
import com.ak.store.catalogue.product.validator.ProductCharacteristicValidator;
...
public class ProductCharacteristicService {
    ...
    private List<ProductCharacteristic> findAllByProductId(Long productId) {
        return productCharacteristicQueryService.findAllByProductId(productId);
    }
