...
//import com.ak.store.user.validator.service.ReviewServiceValidator;
...
//    private final ReviewServiceValidator reviewServiceValidator;
...
//        reviewServiceValidator.validateCreation(productId, consumerId);
//        User user = userService.findOne(consumerId);
//        Review review = reviewMapper.toReview(reviewForm, user, productId);
...
//                .user(User.builder().id(UUID.fromString(consumerId)).build())
