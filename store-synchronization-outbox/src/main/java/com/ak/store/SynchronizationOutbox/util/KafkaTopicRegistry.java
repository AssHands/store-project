package com.ak.store.SynchronizationOutbox.util;
...
public class KafkaTopicRegistry {
    ...
    public void init() {
        Map<OutboxEventType, String> eventKeyMap = Map.ofEntries(
                Map.entry(OutboxEventType.PRODUCT_SYNCHRONIZATION, "product-synchronization"),
                Map.entry(OutboxEventType.CANCEL_PRODUCT_SYNCHRONIZATION, "cancel-product-synchronization")
        );
