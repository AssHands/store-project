...
@Service
public class CancelUserPaymentCreationOutboxEventProcessor implements OutboxEventProcessor {
    ...
    public void process(InboxEvent event) {
        ...
        try {
            outboxEventService.createOne(event.getId(), response, OutboxEventType.CANCEL_USER_PAYMENT_CREATION);
