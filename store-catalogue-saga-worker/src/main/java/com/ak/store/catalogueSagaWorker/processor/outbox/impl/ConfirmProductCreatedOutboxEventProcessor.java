...
@Service
public class ConfirmProductCreatedOutboxEventProcessor implements OutboxEventProcessor {
    ...
    public void process(InboxEvent event) {
        ...
        try {
            outboxEventService.createOne(event.getId(), response, OutboxEventType.CONFIRM_PRODUCT_CREATED);
