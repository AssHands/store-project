...
@Service
public class RemoveProductGradeOutboxEventProcessor implements OutboxEventProcessor {
    ...
    public void process(InboxEvent event) {
        ...
        try {
            outboxEventService.createOne(event.getId(), response, OutboxEventType.REMOVE_PRODUCT_GRADE);
