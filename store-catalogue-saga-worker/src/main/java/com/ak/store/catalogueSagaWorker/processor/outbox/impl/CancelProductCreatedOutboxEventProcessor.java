...
@Service
public class CancelProductCreatedOutboxEventProcessor implements OutboxEventProcessor {
    ...
    public void process(InboxEvent event) {
        ...
        try {
            outboxEventService.createOne(event.getId(), response, OutboxEventType.CANCEL_PRODUCT_CREATED);
