package com.ak.store.reviewSagaWorker.processor.outbox.deleted;
...
@Service
public class CancelReviewDeletedOutboxEventProcessor implements OutboxEventProcessor {
    ...
    public void process(InboxEvent event) {
        ...
        try {
            outboxEventService.createOne(event.getId(), response, OutboxEventType.CANCEL_REVIEW_DELETED);
    ...
    public InboxEventType getType() {
        return InboxEventType.CANCEL_REVIEW_DELETED;
    }
}
