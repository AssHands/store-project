...
@Service
public class ConfirmReviewUpdateOutboxEventProcessor implements OutboxEventProcessor {
    ...
    public void process(InboxEvent event) {
        ...
        outboxEventService.createOne(event.getId(), response, OutboxEventType.CONFIRM_REVIEW_UPDATE);
    }
