...
import com.ak.store.reviewSagaWorker.model.dto.ConfirmReviewUpdateRequest;
...
public class ConfirmReviewUpdateInboxEventProcessor implements InboxEventProcessor {
    ...
    public void process(InboxEvent event) {
        var request = gson.fromJson(event.getPayload(), ConfirmReviewUpdateRequest.class);
        reviewService.updateOneStatus(new ObjectId(request.getReview().getId()), ReviewStatus.COMPLETED);
    }
