...
import com.ak.store.reviewSagaWorker.model.dto.CancelReviewDeletionRequest;
...
public class CancelReviewDeletionInboxEventProcessor implements InboxEventProcessor {
    ...
    public void process(InboxEvent event) {
        var request = gson.fromJson(event.getPayload(), CancelReviewDeletionRequest.class);
