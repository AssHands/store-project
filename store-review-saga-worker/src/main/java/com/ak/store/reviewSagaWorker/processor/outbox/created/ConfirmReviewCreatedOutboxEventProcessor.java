package com.ak.store.reviewSagaWorker.processor.outbox.created;
...
@Service
public class ConfirmReviewCreatedOutboxEventProcessor implements OutboxEventProcessor {
    ...
    public void process(InboxEvent event) {
        ...
        try {
            outboxEventService.createOne(event.getId(), response, OutboxEventType.CONFIRM_REVIEW_CREATED);
    ...
    public InboxEventType getType() {
        return InboxEventType.CONFIRM_REVIEW_CREATED;
    }
}
