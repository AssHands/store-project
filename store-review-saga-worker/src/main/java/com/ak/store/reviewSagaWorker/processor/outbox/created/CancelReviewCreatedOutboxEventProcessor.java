...
@Service
public class CancelReviewCreatedOutboxEventProcessor implements OutboxEventProcessor {
    ...
    public void process(InboxEvent event) {
        ...
        try {
            outboxEventService.createOne(event.getId(), response, OutboxEventType.CANCEL_REVIEW_CREATED);
